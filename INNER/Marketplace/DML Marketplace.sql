...
SELECT Clientes.Nome AS Nome, Clientes.Email AS Email, Clientes.DadosPagamento AS 'Forma Pagamento', Produtos.Preco
FROM Clientes
LEFT JOIN Produtos ON Clientes.Id = FK_Anunciante

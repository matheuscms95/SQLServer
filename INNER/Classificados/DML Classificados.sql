...
SELECT Clientes.Nome AS Nome, Clientes.Email AS Email, Clientes.Foto AS 'Foto Perfil', Classificados.Valor AS Preço, Classificados.Foto AS 'Foto produto'
FROM Clientes
RIGHT JOIN Classificados ON Clientes.Id = FK_Nome

SELECT AVG(Valor) Valor FROM Classificados